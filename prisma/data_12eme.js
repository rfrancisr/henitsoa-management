...
const DECEMBRE_12EME = [
...

  {
    ...
    theme:"BULLETINS — Remise des bulletins et bilan du 1er trimestre",
    matieres:[

      m("LECTURE","Bilan du trimestre — relire librement les syllabes connues (l, t, d, n, m)",
        "Clore le trimestre par une activité calme et non notée : relecture libre et ludique de toutes les syllabes formées depuis octobre, pour consolider sans pression avant la remise des bulletins.",
        ["Afficher un grand tableau récapitulatif de toutes les syllabes du trimestre (la, ta, da, na, ma...)","Proposer un jeu de lecture libre : chaque enfant vient lire une syllabe de son choix","Valoriser chaque lecture réussie sans notation","Proposer un jeu de memory avec les syllabes du trimestre","Terminer par une lecture collective de toutes les syllabes en chœur"],
        ["Lis une syllabe de ton choix sur le tableau. → Corrigé : lecture correcte de la syllabe choisie","Trouve une syllabe qui commence comme ton prénom. → Corrigé : syllabe cohérente si possible, sinon syllabe au choix","Joue au memory des syllabes avec un camarade. → Corrigé : participation à l'activité","Lis toutes les syllabes en chœur avec la classe. → Corrigé : participation collective"]),

      m("VAKITENY","Fehin-kevitra — famerenana ny vakiteny nianarana",
        "Mamarana ny telovolana amin'ny fanamarinana tsy misy naoty : famerenana an-kalalahana ireo vakiteny nianarana hatramin'ny volana Oktobra.",
        ["Manisy sary lehibe misy ny vakiteny rehetra nianarana","Manasa ny ankizy tsirairay hisafidy vakiteny iray ho vakiny","Mankasitraka ny fahavitan'ny tsirairay","Manao lalao memory amin'ny vakiteny"],
        ["Vakio ny vakiteny safidianao. → Valiny : vakiteny voavaky tsara","Manao lalao memory ianao. → Valiny : fandraisana anjara","Vakio miaraka ny kilasy manontolo. → Valiny : fandraisana anjara iombonana","Inona ny vakiteny tianao indrindra ? → Valiny : valiny manokana"]),

      m("ÉCRITURE","Bilan du trimestre — cahier d'écriture, retour sur les progrès",
        "Feuilleter avec chaque enfant son cahier d'écriture depuis octobre pour observer collectivement les progrès du tracé, dans une ambiance calme et valorisante avant la remise des bulletins.",
        ["Distribuer à chaque enfant son cahier d'écriture du trimestre","Comparer une page d'octobre et une page de décembre","Faire tracer librement sa lettre préférée du trimestre","Valoriser les progrès observés"],
        ["Montre la page d'octobre et la page de décembre de ton cahier. → Corrigé : pages retrouvées","Quelle lettre préfères-tu tracer ? → Corrigé : réponse personnelle","Trace ta lettre préférée une dernière fois. → Corrigé : tracé produit","Que remarques-tu entre ton écriture d'octobre et celle de maintenant ? → Corrigé : réponse personnelle, progrès observé"]),

      m("LANGAGE","Bilan du trimestre — histoire « François va chez le coiffeur »",
        "Faire un retour collectif et calme sur l'histoire suivie tout le trimestre, en clôturant ce premier grand récit avant d'en découvrir un nouveau en janvier.",
        ["Rassembler tous les enfants pour une dernière écoute complète de l'histoire","Discussion libre : ce qu'on a préféré dans l'histoire","Dessiner son moment préféré de l'histoire"],
        ["Quel est ton moment préféré de l'histoire ? → Corrigé : réponse personnelle","Dessine ce moment. → Corrigé : production personnelle","Raconte l'histoire en une phrase. → Corrigé : phrase cohérente avec l'histoire","Aimerais-tu une nouvelle histoire en janvier ? → Corrigé : réponse personnelle"]),

      m("PRE-MATH","Bilan du trimestre — jeux calmes autour des formes et des nombres en lettres",
        "Proposer des jeux calmes de consolidation (sans notation) autour des notions du trimestre : formes, autant/plus, un/zéro en lettres, égalité/différence.",
        ["Installer un coin jeu avec les formes, jetons et cartes-mots du trimestre","Laisser les enfants jouer librement par petits groupes","Circuler pour valoriser les bonnes manipulations"],
        ["Montre une forme de ton choix et nomme-la. → Corrigé : forme nommée correctement","Fabrique 2 collections égales avec des jetons. → Corrigé : collections égales réalisées","Montre le mot « un ». → Corrigé : mot pointé correctement","Explique à un camarade ce qu'est « autant ». → Corrigé : explication cohérente avec la notion apprise"]),

      m("MATHS","Bilan du trimestre — jeux de nombres de 0 à 20",
        "Consolider par le jeu, sans notation, l'ensemble des nombres travaillés depuis octobre (0 à 20), avant la remise des bulletins.",
        ["Proposer un jeu de loto des nombres de 0 à 20","Jeu de la marchande : compter et échanger des jetons","Réciter ensemble la suite de 0 à 20"],
        ["Joue au loto des nombres avec un camarade. → Corrigé : participation à l'activité","Récite avec la classe la suite de 0 à 20. → Corrigé : participation collective","Compte 12 jetons pour « acheter » un objet au jeu de la marchande. → Corrigé : 12 jetons comptés","Quel nombre du trimestre connais-tu le mieux ? → Corrigé : réponse personnelle"]),

      m("MORALE","Bilan moral du trimestre — mes progrès",
        "Faire un bilan collectif et valorisant des règles de vie apprises depuis octobre (propreté, discipline, respect), en clôture du trimestre.",
        ["Rappeler ensemble les règles apprises depuis octobre","Chaque enfant cite une règle qu'il applique bien","Valoriser les progrès individuels devant la classe"],
        ["Cite une règle apprise ce trimestre que tu appliques bien. → Corrigé : réponse personnelle cohérente avec les règles vues","Pourquoi est-il important de bien se comporter ? → Corrigé : pour vivre bien ensemble et rester en sécurité","Quelle règle veux-tu encore améliorer ? → Corrigé : réponse personnelle","Félicite un camarade pour une bonne action. → Corrigé : parole positive formulée"]),

      m("ENVIRONNEMENT","Bilan du trimestre — ce que j'ai découvert (toilette, vêtements, météo, pluie, cuisine, fruits)",
        "Faire un retour ludique et collectif sur tous les thèmes du trimestre en environnement, sans nouvelle notion ni évaluation.",
        ["Afficher toutes les images vues depuis octobre","Chaque enfant choisit une image et raconte ce qu'il en sait","Jeu collectif de tri par thème"],
        ["Choisis une image et dis ce que tu en sais. → Corrigé : réponse personnelle cohérente","Range ces images par thème avec la classe. → Corrigé : classement collectif réalisé","Quel thème as-tu préféré ce trimestre ? → Corrigé : réponse personnelle","Cite un mot que tu as appris ce trimestre. → Corrigé : mot réellement vu depuis octobre"]),

      m("ANGLAIS","Révision légère — flashcards de tout le trimestre",
        "Réviser en jeu libre, sans notation, l'ensemble du vocabulaire anglais vu depuis octobre.",
        ["Étaler toutes les flashcards du trimestre sur une table","Jeu libre : chaque enfant pioche et nomme une carte","Chanter les chansons anglaises apprises ce trimestre"],
        ["Pioche une carte et nomme-la en anglais. → Corrigé : mot anglais correct pour la carte piochée","Sing a song you learned this term. → Corrigé : chanson chantée conformément aux paroles apprises","How do you say « bonjour » in English? → Corrigé : Hello / Good morning","Quel mot anglais préfères-tu ? → Corrigé : réponse personnelle"]),

      m("CHANT","Bilan — grande chorale des chants du trimestre",
        "Réunir toute la classe pour chanter ensemble tous les chants appris depuis octobre, en clôture festive du trimestre.",
        ["Chanter chaque chant du trimestre en grand groupe","Laisser un temps de vote pour le chant préféré de la classe","Chanter le chant préféré une dernière fois tous ensemble"],
        ["Chante avec la classe le chant préféré du trimestre. → Corrigé : participation collective au chant choisi","Quel est ton chant préféré du trimestre ? → Corrigé : réponse personnelle","Montre un geste d'un chant du trimestre. → Corrigé : geste conforme à un chant appris","Combien de chants avons-nous appris ce trimestre ? → Corrigé : nombre réel de chants appris depuis octobre"]),

      m("RECITATION","Bilan — grande récitation collective des poèmes du trimestre",
        "Réunir la classe pour réciter ensemble tous les poèmes appris depuis octobre, en clôture calme et valorisante du trimestre.",
        ["Réciter chaque poème du trimestre en grand groupe","Vote pour le poème préféré de la classe","Réciter le poème préféré une dernière fois tous ensemble"],
        ["Récite avec la classe le poème préféré du trimestre. → Corrigé : participation collective","Quel est ton poème préféré ? → Corrigé : réponse personnelle","Combien de poèmes avons-nous appris ce trimestre ? → Corrigé : nombre réel de poèmes appris depuis octobre","Récite seul la première ligne de ton poème préféré. → Corrigé : ligne récitée conforme au texte appris"]),

      m("EPS","Bilan — parcours ludique des mouvements du trimestre",
        "Proposer un parcours ludique et non noté reprenant tous les mouvements travaillés depuis octobre (course, roulade, dedans-dehors, saut), en clôture du trimestre.",
        ["Installer un parcours complet avec les 4 ateliers du trimestre","Faire passer chaque enfant sur le parcours en s'amusant","Encourager et applaudir chaque passage"],
        ["Fais le parcours complet du trimestre. → Corrigé : parcours réalisé avec plaisir, sans exigence de performance","Quel atelier as-tu préféré ce trimestre ? → Corrigé : réponse personnelle","Montre le mouvement que tu maîtrises le mieux. → Corrigé : mouvement réalisé correctement","Encourage un camarade sur le parcours. → Corrigé : parole d'encouragement formulée"]),

      m("DESSIN","Bilan — exposition des dessins du trimestre",
        "Organiser une petite exposition des dessins réalisés depuis octobre pour que chaque enfant présente sa production préférée, en clôture valorisante du trimestre.",
        ["Rassembler tous les dessins du trimestre de chaque enfant","Chaque enfant choisit son dessin préféré à exposer","Présenter son dessin à la classe en une phrase"],
        ["Choisis ton dessin préféré du trimestre. → Corrigé : choix personnel","Présente ton dessin en une phrase. → Corrigé : phrase cohérente avec le dessin choisi","Que représente ce dessin ? → Corrigé : réponse conforme à la production réelle","Quel dessin d'un camarade as-tu aimé ? → Corrigé : réponse personnelle"]),

      m("TRAVAUX MANUELS","Bilan — exposition des productions manuelles du trimestre",
        "Exposer les réalisations manuelles du trimestre (coloriage, peinture, pliage, modelage) pour clôturer sur une note valorisante et calme.",
        ["Rassembler toutes les productions manuelles du trimestre","Organiser un petit coin exposition dans la classe","Chaque enfant présente sa production préférée"],
        ["Choisis ta production préférée du trimestre. → Corrigé : choix personnel","Quelle technique as-tu préférée (coloriage, peinture, pliage, modelage) ? → Corrigé : réponse personnelle","Présente ta production à un camarade. → Corrigé : présentation orale réalisée","Range le coin exposition avec la classe. → Corrigé : participation au rangement"]),

      m("CONTE","Bilan — les 2 contes du trimestre racontés en grand groupe",
        "Réunir la classe pour se remémorer les 2 contes du trimestre (Ikotobekibo sy Faramalemy, Ny saka sy ny totozy) avant la remise des bulletins.",
        ["Rappeler les personnages des 2 contes avec les images","Voter pour le conte préféré de la classe","Raconter une dernière fois le conte préféré en grand groupe"],
        ["Quel conte as-tu préféré ce trimestre ? → Corrigé : réponse personnelle","Cite les personnages des 2 contes du trimestre. → Corrigé : Ikotobekibo, Faramalemy, saka, totozy","Raconte le conte préféré en 2 phrases. → Corrigé : résumé oral cohérent avec le conte choisi","Quelle leçon retiens-tu de ces 2 contes ? → Corrigé : réponse cohérente avec les morales des contes"])

    ],
  },

  // TODO PHASE 4 : fusionner avec la semaine précédente (ancien "Décembre n:4", 22/12/2025 – 26/12/2025) — pas de semaine réelle disponible cette année
  {
    n:4, dates:"A_FUSIONNER_PHASE4",
    theme:"VACANCES DE NOËL — Pas de cours",
    matieres:[

      m("LECTURE","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Lecture.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("VAKITENY","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Vakiteny.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("ÉCRITURE","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Écriture.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("LANGAGE","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Langage.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("PRE-MATH","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Pré-math.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("MATHS","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Maths.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("MORALE","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Morale.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("ENVIRONNEMENT","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Environnement.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("ANGLAIS","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Anglais.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("CHANT","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Chant.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("RECITATION","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Récitation.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("EPS","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en EPS.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("DESSIN","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Dessin.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("TRAVAUX MANUELS","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Travaux manuels.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"]),

      m("CONTE","Vacances de Noël — pas de cours",
        "Cette semaine correspond au début des vacances de Noël : il n'y a pas de classe et donc aucun nouveau contenu pédagogique n'est prévu en Conte.",
        ["Pas d'activité de classe cette semaine — vacances de Noël"],
        ["Pas d'exercice cette semaine — vacances de Noël"])
