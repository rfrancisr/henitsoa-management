...
export const TRANSLATIONS = {
  fr: {
      ...
      fallback: [
        {
          ...
          excerpt: "Places limitées en Maternelle et en classe de 11ᵉ. Réservez votre entretien dès maintenant.",
        },
        {
          date: "28 mai",
          category: "Résultats",
          title: "Henitsoa 1ʳᵉ place au CEPE 2026 !",
          excerpt: "Toute l'équipe est fière de nos élèves de 11ᵉ pour ce classement national.",
        },
        {
          date: "15 oct",
          category: "Événement",
          title: "Journée portes ouvertes",
          excerpt: "Venez visiter les classes, rencontrer les enseignants et poser vos questions.",
        },
      ],
    },
    events: {
    ...
    admission: {
      eyebrow: "Collège Privé Henitsoa",
      hero_title: "Rentrée scolaire",
      hero_years: "2026 – 2027",
      hero_subtitle: "Inscriptions & réinscriptions ouvertes dès maintenant",
      period_label: "01 — 31 juillet 2026",
      new_title: "Nouveaux élèves",
      new_subtitle: "Inscription",
      new_items: [
        "1 copie & enveloppe",
        "4 photos d'identité",
        "Élève ayant déjà étudié : certificat de scolarité, bulletin de notes et fiche d'écolages de l'école précédente",
      ],
      new_fee_label: "Droit d'inscription",
      new_fee: "90 000 Ar",
      new_tuition_label: "Écolage",
      new_tuition: "30 000 Ar",
      returning_title: "Anciens élèves",
      returning_subtitle: "Réinscription",
      returning_items: [
        "3 photos d'identité",
        "Rapporter le bulletin de notes et le carnet de correspondance de l'année précédente",
      ],
      returning_fee_label: "Droit de réinscription",
      returning_fee: "85 000 Ar",
      returning_tuition_label: "Écolage",
      returning_tuition: "30 000 Ar",
      age_title: "Âge & classe",
      age_subtitle: "Année scolaire 2026-2027",
      age_rows: [
        { born: "Né en 2025", cls: "Garderie" },
        { born: "Né en 2024", cls: "Jardin d'enfants" },
        { born: "Né en 2023", cls: "Maternelle" },
        { born: "Né en 2022", cls: "12ème" },
        { born: "Né en 2021", cls: "11ème" },
      ],
      hours_title: "Heures d'ouverture du bureau",
      hours_rows: [
        { period: "Matin", time: "9h – 11h" },
        { period: "Après-midi", time: "14h – 16h" },
      ],
      hours_note: "Retrait du certificat de scolarité pour ceux qui en ont besoin.",
      transport_label: "Transport Bajaja",
      transport_note: "Places limitées — inscrivez votre enfant à l'avance auprès du bureau.",
      banner_tag: "Rentrée des classes",
      banner_date: "08 septembre 2026",
      banner_quote: "« Un enfant bien éduqué est un avenir assuré »",
    },
  },
  ...
  mg: {
    nav: {
      ...
      admission: "Soraty anarana ny zanako",
    },
    hero: {
    ...
    news: {
      ...
      fallback: [
        {
          date: "12 jona",
          category: "Fisoratana anarana",
          title: "Efa misokatra ny fisoratana anarana 2026–2027",
          excerpt: "Voafetra ny toerana amin'ny Maternelle sy ny kilasy faha-11. Manaova fanaovan-dahatra izao.",
        },
        {
          date: "28 mey",
          category: "Vokatra",
          title: "Henitsoa laharana voalohany tamin'ny CEPE 2026 !",
          excerpt: "Faly ny ekipa manontolo amin'ny mpianatra kilasy faha-11 noho izany laharana nasionaly izany.",
        },
        {
          date: "15 okt",
          category: "Hetsika",
          title: "Andro fanokafana varavarana",
          excerpt: "Tongava mitsidika ny efitrano fianarana, mihaona amin'ny mpampianatra ary manontany.",
        },
      ],
    },
    events: {
    ...
    admission: {
      eyebrow: "Kolejy Manokana Henitsoa",
      hero_title: "Fidirana am-pianarana",
      hero_years: "2026 – 2027",
      hero_subtitle: "Efa misokatra ny fisoratana anarana sy ny famerenana anarana",
      period_label: "01 — 31 Jolay 2026",
      new_title: "Mpianatra vaovao",
      new_subtitle: "Fisoratana anarana",
      new_items: [
        "1 kopia & valopy",
        "Sary 4 (4x4)",
        "Ho an'ny efa nianatra taloha : taratasy fanamarinana fianarana, bulletin ary taratasy fandoavan-bola tamin'ny sekoly teo aloha",
      ],
      new_fee_label: "Saram-pisoratana anarana",
      new_fee: "90 000 Ar",
      new_tuition_label: "Fandoavan-bola",
      new_tuition: "30 000 Ar",
      returning_title: "Mpianatra taloha",
      returning_subtitle: "Famerenana anarana",
      returning_items: [
        "Sary 3 (4x4)",
        "Ento ny bulletin sy ny bokim-pifandraisana tamin'ny taom-pianarana teo aloha",
      ],
      returning_fee_label: "Saram-pamerenana anarana",
      returning_fee: "85 000 Ar",
      returning_tuition_label: "Fandoavan-bola",
      returning_tuition: "30 000 Ar",
      age_title: "Ny taonan'ny zaza sy ny kilasiny",
      age_subtitle: "Taona & kilasy — taom-pianarana 2026-2027",
      age_rows: [
        { born: "Teraka 2025", cls: "Garderie" },
        { born: "Teraka 2024", cls: "Jardin d'enfants" },
        { born: "Teraka 2023", cls: "Maternelle" },
        { born: "Teraka 2022", cls: "Kilasy faha-12" },
        { born: "Teraka 2021", cls: "Kilasy faha-11" },
      ],
      hours_title: "Ora fisokafan'ny birao",
      hours_rows: [
        { period: "Maraina", time: "9h – 11h" },
        { period: "Hariva", time: "14h – 16h" },
      ],
      hours_note: "Fakàna ny taratasy fanamarinana fianarana ho an'ireo mila izany.",
      transport_label: "Fitaterana Bajaja",
      transport_note: "Voafetra ny toerana — soraty anarana mialoha ny zanakao any amin'ny birao.",
      banner_tag: "Fanokafan'ny kilasy",
      banner_date: "08 Septambra 2026",
      banner_quote: "« Zaza voaentana tsara dia hoavy azo antoka »",
    },
  },
};
